"""Unit tests for soundfetch.export — export_attribution and _select_downloaded.

Heavy-dep functions (to_hf_dataset, to_webdataset) are gated behind
importorskip so they run only when the optional deps are installed.
"""
